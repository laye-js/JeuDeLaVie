...
public class GameUI extends JFrame {
    ...
    private JButton demarrerBtn, arreterBtn, pauseBtn, resetBtn, guideBtn, reglesBtn;
    ...
    private void initUI() {
        ...
        // Styliser les boutons avec des couleurs différentes
        ...
        guideBtn.setBackground(Color.CYAN);
        reglesBtn.setBackground(Color.MAGENTA);
        reglesBtn.setBorderPainted(false);
        ...
        setSize(1000, 1000); // Définir la taille initiale
    ...
    private void updateUI() {
        SwingUtilities.invokeLater(() -> {
            ...
            // Forcer le rafraîchissement de l'interface graphique
            repaint();
        });
    }
